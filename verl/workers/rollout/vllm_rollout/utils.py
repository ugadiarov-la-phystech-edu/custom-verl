...
class vLLMColocateWorkerExtension:
    ...
    def _batch_stats_gpu_id(self) -> str:
        ...
        # Workers in the same replica share CUDA_VISIBLE_DEVICES; the physical GPU
        # for this worker is the local_rank-th visible device, not the first.
    ...
    def init_batch_stats(self):
        ...
        def execute_model(_self, scheduler_output, *args, **kwargs):
            ...
            # Read batch sizes before the call (scheduler_output may be consumed by it).
