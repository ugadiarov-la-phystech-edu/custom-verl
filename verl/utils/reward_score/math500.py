...
# Probe for the math-verify package itself: the verl wrapper module imports
# fine without it (its package import happens in a subprocess worker), so a
# try/except around `from . import math_verify` would not detect absence.
