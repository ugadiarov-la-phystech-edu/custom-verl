...
def register(dispatch_mode=Dispatch.ALL_TO_ALL, execute_mode=Execute.ALL, blocking=True, materialize_futures=True):
    ...
    def decorator(func):
        # Map this method to a per-GPU phase code once, at decoration time, so the per-call hot path
        # is a single local-is-None check for the (vast) majority of non-phase methods.
