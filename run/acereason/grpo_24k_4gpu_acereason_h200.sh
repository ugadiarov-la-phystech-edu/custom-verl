...
source "$SETUP_PATH"
# 4-GPU variant: override the 6-GPU defaults from setup_datasets_acereason.sh
export NUM_GPU=4
export CUDA_VISIBLE_DEVICES=0,1,2,3
export RUN_NAME="grpo_8B_acereason_24k_4gpu_h200_$(date +%Y%m%d-%H%M%S)"
