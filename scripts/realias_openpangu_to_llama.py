...
Idempotent -- safe to re-run. Verify the result with ``scripts/preflight_openpangu.py --model-path``.
...
def main():
    ...
    print(f"\nNext: python scripts/preflight_openpangu.py --model-path {args.out}")
    return 0
